...
Regression coverage for previously untested UI-reachable engine functions and constant-backed assertions for tax limits, so drift is caught by the Node/browser test suite instead of shipping silently.
