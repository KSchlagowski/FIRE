...
Safe rendering of the FIRE-progress ratio and progress ring for degenerate inputs (zero target, zero/negative portfolio) so the dashboard never shows a false "reached" or a broken ring.
